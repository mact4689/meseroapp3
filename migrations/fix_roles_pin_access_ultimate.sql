-- ==============================================================================
-- REPARACIÓN Y SINCRONIZACIÓN ULTIMATE DE PIN DE ROLES (MESEROAPP)
-- ==============================================================================
-- Ejecuta este script en el editor SQL de Supabase para reparar
-- y verificar completamente los PINs de seguridad y los accesos de personal.
...
-- 4. Crear/Recrear función de trigger para roles de personal (QR)
-- Separamos lógicas de INSERT y UPDATE para evitar errores con la variable OLD en inserts.
...
-- 6. Recrear permisos generales de SELECT para dueños
GRANT SELECT, INSERT, UPDATE, DELETE ON public.custom_roles TO authenticated;
GRANT SELECT, UPDATE ON public.profiles TO authenticated;


-- 7. Recrear RPC para verificar PIN de Roles por QR
...
-- 10. REPORTE DE COMPROBACIÓN FINAL
SELECT 
    id, 
    name as nombre_rol, 
